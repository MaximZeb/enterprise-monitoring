...
function counterUral(num: number, machine_readings_index: number, randomNum: number = 0.02, checkout: boolean = true, technicIndex: number = 0) {
  let arr = (mockIndictions[technicIndex]as ITechnicData).indications[0] .machine_readings[machine_readings_index].readings;
  let newNum = num + 1;
  if (arr.length === num) {
  ...
  (mockIndictions[technicIndex]as ITechnicData).indications[0].machine_readings[machine_readings_index].readings = arr;
}
